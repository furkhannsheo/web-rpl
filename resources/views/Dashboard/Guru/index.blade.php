<x-appDashboard>
    <h1 class="fw-bold" style="font-weight: 1200;"> List Guru </h1>
    <hr class="p-3">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('guru.create') }}" class="px-3 py-2 rounded border-0 darkKita">
                        ...
                        <tbody>
                            @foreach ($gurus as $guru)
                                <tr>
                                    <td>
                                        @if ($guru->gambar)
                                            <img src="{{ asset('storage/' . $guru->gambar) }}" class="img-thumbnail"
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                            data-bs-target="#deleteModal{{ $guru->id }}"><i
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-body text-center p-4">
                                                ...
                                                <p class="mb-4">Guru <b>{{ $guru->nama }}</b> akan dihapus permanen.
                                                </p>
