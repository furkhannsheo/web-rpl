<section id="berita" class="py-20 bg-brand-light">
    <div class="container mx-auto px-6 animate-on-scroll">
        ...
        <div id="news-filter" class="mb-8 flex flex-wrap justify-center gap-2 md:gap-4 px-4 md:px-0">
                ...
                <div class="news-item bg-white rounded-2xl overflow-hidden shadow-card group"
                    ...
                    <div class="p-6">
                        ...
                        <a href="{{ route('detail.berita', $item->slug) }}"
                            ...
                            Baca Selengkapnya
                            <span class="transition-transform duration-300 group-hover/link:translate-x-1">&rarr;</span>
                        </a>
                    </div>
                </div>
            @empty
                <div class="col-span-3 text-center py-16">
                    <div class="bg-white shadow-md rounded-2xl p-10 max-w-md mx-auto">
                        ...
                        <p class="text-gray-500 mt-2">Berita & acara terbaru akan tampil di sini setelah ditambahkan.
                        </p>
                    </div>
                </div>
            @endforelse
        ...
        <div class="mt-8 text-center">
            <a href="{{ route('list.semua.berita') }}"
